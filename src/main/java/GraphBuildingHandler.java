...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private GraphDB.Vertex currentVertex;
    private List<Long> tempConnectionList = new ArrayList<>();
